...
const base = [
  ...
  // Border
  'border border-teal-950/15 group-data-[checked]:border-transparent group-data-[checked]:group-data-[hover]:border-transparent group-data-[hover]:border-teal-950/30 group-data-[checked]:bg-[--checkbox-checked-border]',
  ...
  'group-data-[disabled]:border-teal-950/25 group-data-[disabled]:bg-teal-950/5 group-data-[disabled]:[--checkbox-check:theme(colors.zinc.950/50%)] group-data-[disabled]:before:bg-transparent',
