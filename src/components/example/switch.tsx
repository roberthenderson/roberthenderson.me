  ...
  return (
    <Headless.Switch
      ...
      className={clsxMerge(
        ...
        // Unchecked
        'bg-teal-200 ring-1 ring-inset ring-black/5 dark:bg-white/5 dark:ring-white/15',
        // Checked
        ...
        // Disabled
        'data-[disabled]:bg-teal-200 data-[disabled]:data-[checked]:bg-teal-200 data-[disabled]:opacity-50 data-[disabled]:data-[checked]:ring-black/5',
