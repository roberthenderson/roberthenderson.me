...
const base = [
  ...
  // Border
  'border border-teal-950/15 group-data-[checked]:border-transparent group-data-[checked]:group-data-[hover]:border-transparent group-data-[hover]:border-teal-950/30 group-data-[checked]:bg-[--radio-checked-border]',
  ...
  'group-data-[disabled]:border-teal-950/25 group-data-[disabled]:bg-teal-950/5 group-data-[disabled]:[--radio-checked-indicator:theme(colors.zinc.950/50%)] group-data-[disabled]:before:bg-transparent',
...
>) {
  return (
    <Headless.Radio
      data-slot="control"
      {...props}
      className={clsxMerge(className, 'group inline-flex focus:outline-none')}
    >
      <span className={clsxMerge([base, colors[color]])}>
        <span
          className={clsxMerge(
