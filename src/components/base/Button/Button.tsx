...
const styles = {
  ...
  outline: [
    // Base
    'border-teal-950/10 text-teal-950 data-[active]:bg-teal-950/[2.5%] data-[hover]:bg-teal-950/[2.5%]',
    // Dark mode
    'dark:border-white/15 dark:text-white dark:[--btn-bg:transparent] dark:data-[active]:bg-white/5 dark:data-[hover]:bg-white/5',
    // Icon
    '[--btn-icon:theme(colors.teal.500)] data-[active]:[--btn-icon:theme(colors.teal.700)] data-[hover]:[--btn-icon:theme(colors.teal.700)] dark:data-[active]:[--btn-icon:theme(colors.teal.400)] dark:data-[hover]:[--btn-icon:theme(colors.teal.400)]',
  ],
  plain: [
    // Base
    'border-transparent text-teal-950 data-[active]:bg-teal-950/5 data-[hover]:bg-teal-950/5',
    // Dark mode
    'dark:text-white dark:data-[active]:bg-white/10 dark:data-[hover]:bg-white/10',
    // Icon
    '[--btn-icon:theme(colors.teal.500)] data-[active]:[--btn-icon:theme(colors.teal.700)] data-[hover]:[--btn-icon:theme(colors.teal.700)] dark:[--btn-icon:theme(colors.teal.500)] dark:data-[active]:[--btn-icon:theme(colors.teal.400)] dark:data-[hover]:[--btn-icon:theme(colors.teal.400)]',
  ],
  colors: {
    'dark/teal': [
      'text-white [--btn-bg:theme(colors.teal.900)] [--btn-border:theme(colors.teal.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]',
      'dark:text-white dark:[--btn-bg:theme(colors.teal.600)] dark:[--btn-hover-overlay:theme(colors.white/5%)]',
      '[--btn-icon:theme(colors.teal.400)] data-[active]:[--btn-icon:theme(colors.teal.300)] data-[hover]:[--btn-icon:theme(colors.teal.300)]',
    ],
    light: [
      'text-teal-950 [--btn-bg:white] [--btn-border:theme(colors.teal.950/10%)] [--btn-hover-overlay:theme(colors.teal.950/2.5%)] data-[active]:[--btn-border:theme(colors.teal.950/15%)] data-[hover]:[--btn-border:theme(colors.teal.950/15%)]',
      'dark:text-white dark:[--btn-hover-overlay:theme(colors.white/5%)] dark:[--btn-bg:theme(colors.teal.800)]',
      '[--btn-icon:theme(colors.teal.500)] data-[active]:[--btn-icon:theme(colors.teal.700)] data-[hover]:[--btn-icon:theme(colors.teal.700)] dark:[--btn-icon:theme(colors.teal.500)] dark:data-[active]:[--btn-icon:theme(colors.teal.400)] dark:data-[hover]:[--btn-icon:theme(colors.teal.400)]',
    ],
    'dark/white': [
      'text-white [--btn-bg:theme(colors.teal.900)] [--btn-border:theme(colors.teal.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]',
      'dark:text-teal-950 dark:[--btn-bg:white] dark:[--btn-hover-overlay:theme(colors.teal.950/5%)]',
      '[--btn-icon:theme(colors.teal.400)] data-[active]:[--btn-icon:theme(colors.teal.300)] data-[hover]:[--btn-icon:theme(colors.teal.300)] dark:[--btn-icon:theme(colors.teal.500)] dark:data-[active]:[--btn-icon:theme(colors.teal.400)] dark:data-[hover]:[--btn-icon:theme(colors.teal.400)]',
    ],
    dark: [
      'text-white [--btn-bg:theme(colors.teal.900)] [--btn-border:theme(colors.teal.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]',
      'dark:[--btn-hover-overlay:theme(colors.white/5%)] dark:[--btn-bg:theme(colors.teal.800)]',
      '[--btn-icon:theme(colors.teal.400)] data-[active]:[--btn-icon:theme(colors.teal.300)] data-[hover]:[--btn-icon:theme(colors.teal.300)]',
    ],
    white: [
      'text-teal-950 [--btn-bg:white] [--btn-border:theme(colors.teal.950/10%)] [--btn-hover-overlay:theme(colors.teal.950/2.5%)] data-[active]:[--btn-border:theme(colors.teal.950/15%)] data-[hover]:[--btn-border:theme(colors.teal.950/15%)]',
      'dark:[--btn-hover-overlay:theme(colors.teal.950/5%)]',
      '[--btn-icon:theme(colors.teal.400)] data-[active]:[--btn-icon:theme(colors.teal.500)] data-[hover]:[--btn-icon:theme(colors.teal.500)]',
    ],
    teal: [
...
export const Button = forwardRef(function Button(
  ...
  let classes = clsxMerge(
    ...
    outline
      ...
      : plain
        ? styles.plain
        : clsxMerge(styles.solid, styles.colors[color ?? 'dark/teal']),
  );
  ...
  return 'href' in props ? (
    ...
    <Headless.Button
      {...props}
      className={clsxMerge(classes, 'cursor-default')}
      ref={ref}
    >
      <TouchTarget>{children}</TouchTarget>
    </Headless.Button>
